...
import { setDisplaySize } from "../../../../../actions/pageActions";
...
class Displayicons extends Component {
  ...
  render() {
    let { displaySize, brightness } = this.props.Page;
    ...
    switch (displaySize) {
      case "large":
        largeClasses += brightness === "light" ? " text-black" : " text-white";
        mediumClasses += " text-gray-600 hover:text-black cursor-pointer";
        mediumClasses +=
          brightness === "light" ? " hover:text-black" : " hover:text-white";
        smallClasses += " text-gray-600 cursor-pointer";
        smallClasses +=
          brightness === "light" ? " hover:text-black" : " hover:text-white";
        largeClick = null;
        break;
      case "medium":
        mediumClasses += brightness === "light" ? " text-black" : " text-white";
        largeClasses += " text-gray-600 cursor-pointer";
        largeClasses +=
          brightness === "light" ? " hover:text-black" : " hover:text-white";
        smallClasses += " text-gray-600 cursor-pointer";
        smallClasses +=
        ...
        break;
      case "small":
        smallClasses += brightness === "light" ? " text-black" : " text-white";
        largeClasses += " text-gray-600 cursor-pointer";
        largeClasses +=
          brightness === "light" ? " hover:text-black" : " hover:text-white";
        mediumClasses += " text-gray-600 cursor-pointer";
        mediumClasses +=
          brightness === "light" ? " hover:text-black" : " hover:text-white";
        smallClick = null;
        break;
    ...
    return (
      <div id="Sidebar_Icons_Display" className="flex flex-rows">
        <svg
