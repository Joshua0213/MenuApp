...
class Pageitemmanipulator extends Component {
  ...
  render() {
    ...
    let addIconClasses =
      "w-11/12 bg-gray-100 mb-1 rounded-lg border-2 border-gray-400 hover:border-gray-500 shadow flex justify-around align-items";
    let upIconClasses = " ";
    let downIconClasses = "";
    ...
    return (
      <div className={addIconClasses}>
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          onClick={() => this.props.togglePageSettings()}
        >
