...
class Sectioncontentsettings extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false
    ...
    if (!this.state.open) {
      ...
      content = (
        <div className="flex justify-around text-black hover:text-green-700">
          <span className="text-black">Content Settings</span>
          {icon}
        </div>
      );
...
export default connect(mapStateToProps, {})(Sectioncontentsettings);
